...
class ContactsApi
{
    ...
    {
        return $this->deleteCharactersCharacterIdContactsAsyncWithHttpInfo($character_id, $contact_ids, $datasource, $token, $user_agent, $x_user_agent)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    public function getCharactersCharacterIdContactsWithHttpInfo($character_id, $datasource = 'tranquility', $page = '1', $token = null, $user_agent = null, $x_user_agent = null)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\GetCharactersCharacterIdContacts200Ok[]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 403:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\Forbidden', $e->getResponseHeaders());
    ...
    {
        return $this->getCharactersCharacterIdContactsAsyncWithHttpInfo($character_id, $datasource, $page, $token, $user_agent, $x_user_agent)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    public function getCharactersCharacterIdContactsLabelsWithHttpInfo($character_id, $datasource = 'tranquility', $token = null, $user_agent = null, $x_user_agent = null)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\GetCharactersCharacterIdContactsLabels200Ok[]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 403:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\Forbidden', $e->getResponseHeaders());
    ...
    {
        return $this->getCharactersCharacterIdContactsLabelsAsyncWithHttpInfo($character_id, $datasource, $token, $user_agent, $x_user_agent)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    {
        return $this->postCharactersCharacterIdContactsAsyncWithHttpInfo($character_id, $contact_ids, $standing, $datasource, $label_id, $token, $user_agent, $watched, $x_user_agent)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    {
        return $this->putCharactersCharacterIdContactsAsyncWithHttpInfo($character_id, $contact_ids, $standing, $datasource, $label_id, $token, $user_agent, $watched, $x_user_agent)->then(function ($response) {
            return $response[0];
        });
    }
