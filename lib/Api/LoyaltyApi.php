...
class LoyaltyApi
{
    ...
    public function getCharactersCharacterIdLoyaltyPointsWithHttpInfo($character_id, $datasource = 'tranquility', $token = null, $user_agent = null, $x_user_agent = null)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\GetCharactersCharacterIdLoyaltyPoints200Ok[]', $e->getResponseHeaders());
    ...
    {
        return $this->getCharactersCharacterIdLoyaltyPointsAsyncWithHttpInfo($character_id, $datasource, $token, $user_agent, $x_user_agent)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    public function getLoyaltyStoresCorporationIdOffersWithHttpInfo($corporation_id, $datasource = 'tranquility', $user_agent = null, $x_user_agent = null)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\GetLoyaltyStoresCorporationIdOffers200Ok[]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 500:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\InternalServerError', $e->getResponseHeaders());
    ...
    {
        return $this->getLoyaltyStoresCorporationIdOffersAsyncWithHttpInfo($corporation_id, $datasource, $user_agent, $x_user_agent)->then(function ($response) {
            return $response[0];
        });
    }
