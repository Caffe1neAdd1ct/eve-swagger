...
class ContractsApi
{
    ...
    public function getCharactersCharacterIdContractsWithHttpInfo($character_id, $datasource = 'tranquility', $token = null, $user_agent = null, $x_user_agent = null)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\GetCharactersCharacterIdContracts200Ok[]', $e->getResponseHeaders());
    ...
    {
        return $this->getCharactersCharacterIdContractsAsyncWithHttpInfo($character_id, $datasource, $token, $user_agent, $x_user_agent)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    public function getCharactersCharacterIdContractsContractIdBidsWithHttpInfo($character_id, $contract_id, $datasource = 'tranquility', $token = null, $user_agent = null, $x_user_agent = null)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\GetCharactersCharacterIdContractsContractIdBids200Ok[]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 403:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\Forbidden', $e->getResponseHeaders());
    ...
    {
        return $this->getCharactersCharacterIdContractsContractIdBidsAsyncWithHttpInfo($character_id, $contract_id, $datasource, $token, $user_agent, $x_user_agent)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    protected function getCharactersCharacterIdContractsContractIdBidsRequest($character_id, $contract_id, $datasource = 'tranquility', $token = null, $user_agent = null, $x_user_agent = null)
    {
        ...
        // path params
        if ($contract_id !== null) {
            $resourcePath = str_replace('{' . 'contract_id' . '}', ObjectSerializer::toPathValue($contract_id), $resourcePath);
        }
    ...
    public function getCharactersCharacterIdContractsContractIdItemsWithHttpInfo($character_id, $contract_id, $datasource = 'tranquility', $token = null, $user_agent = null, $x_user_agent = null)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\GetCharactersCharacterIdContractsContractIdItems200Ok[]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 403:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\Forbidden', $e->getResponseHeaders());
    ...
    {
        return $this->getCharactersCharacterIdContractsContractIdItemsAsyncWithHttpInfo($character_id, $contract_id, $datasource, $token, $user_agent, $x_user_agent)->then(function ($response) {
            return $response[0];
        });
    }
