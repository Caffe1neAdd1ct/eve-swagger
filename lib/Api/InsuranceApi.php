...
class InsuranceApi
{
    ...
    public function getInsurancePricesWithHttpInfo($datasource = 'tranquility', $language = 'en-us', $user_agent = null, $x_user_agent = null)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\GetInsurancePrices200Ok[]', $e->getResponseHeaders());
    ...
    {
        return $this->getInsurancePricesAsyncWithHttpInfo($datasource, $language, $user_agent, $x_user_agent)->then(function ($response) {
            return $response[0];
        });
    }
