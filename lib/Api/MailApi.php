...
class MailApi
{
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 403:
                    ...
                    break;
                case 422:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\DeleteCharactersCharacterIdMailLabelsLabelIdUnprocessableEntity', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 500:
    ...
    {
        return $this->deleteCharactersCharacterIdMailLabelsLabelIdAsyncWithHttpInfo($character_id, $label_id, $datasource, $token, $user_agent, $x_user_agent)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    protected function deleteCharactersCharacterIdMailLabelsLabelIdRequest($character_id, $label_id, $datasource = 'tranquility', $token = null, $user_agent = null, $x_user_agent = null)
    {
        ...
        // path params
        if ($label_id !== null) {
            $resourcePath = str_replace('{' . 'label_id' . '}', ObjectSerializer::toPathValue($label_id), $resourcePath);
        }
    ...
    {
        return $this->deleteCharactersCharacterIdMailMailIdAsyncWithHttpInfo($character_id, $mail_id, $datasource, $token, $user_agent, $x_user_agent)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    protected function deleteCharactersCharacterIdMailMailIdRequest($character_id, $mail_id, $datasource = 'tranquility', $token = null, $user_agent = null, $x_user_agent = null)
    {
        ...
        // path params
        if ($mail_id !== null) {
            $resourcePath = str_replace('{' . 'mail_id' . '}', ObjectSerializer::toPathValue($mail_id), $resourcePath);
        }
    ...
    public function getCharactersCharacterIdMailWithHttpInfo($character_id, $datasource = 'tranquility', $labels = null, $last_mail_id = null, $token = null, $user_agent = null, $x_user_agent = null)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\GetCharactersCharacterIdMail200Ok[]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 403:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\Forbidden', $e->getResponseHeaders());
    ...
    {
        return $this->getCharactersCharacterIdMailAsyncWithHttpInfo($character_id, $datasource, $labels, $last_mail_id, $token, $user_agent, $x_user_agent)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    public function getCharactersCharacterIdMailLabelsWithHttpInfo($character_id, $datasource = 'tranquility', $token = null, $user_agent = null, $x_user_agent = null)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\GetCharactersCharacterIdMailLabelsOk', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 403:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\Forbidden', $e->getResponseHeaders());
    ...
    {
        return $this->getCharactersCharacterIdMailLabelsAsyncWithHttpInfo($character_id, $datasource, $token, $user_agent, $x_user_agent)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    public function getCharactersCharacterIdMailListsWithHttpInfo($character_id, $datasource = 'tranquility', $token = null, $user_agent = null, $x_user_agent = null)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\GetCharactersCharacterIdMailLists200Ok[]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 403:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\Forbidden', $e->getResponseHeaders());
    ...
    {
        return $this->getCharactersCharacterIdMailListsAsyncWithHttpInfo($character_id, $datasource, $token, $user_agent, $x_user_agent)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    public function getCharactersCharacterIdMailMailIdWithHttpInfo($character_id, $mail_id, $datasource = 'tranquility', $token = null, $user_agent = null, $x_user_agent = null)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\GetCharactersCharacterIdMailMailIdOk', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 403:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\Forbidden', $e->getResponseHeaders());
                    ...
                    break;
                case 404:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\GetCharactersCharacterIdMailMailIdNotFound', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 500:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\InternalServerError', $e->getResponseHeaders());
    ...
    {
        return $this->getCharactersCharacterIdMailMailIdAsyncWithHttpInfo($character_id, $mail_id, $datasource, $token, $user_agent, $x_user_agent)->then(function ($response) {
            return $response[0];
        });
    }
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    ...
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\PostCharactersCharacterIdMailBadRequest', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 403:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\Forbidden', $e->getResponseHeaders());
    ...
    {
        return $this->postCharactersCharacterIdMailAsyncWithHttpInfo($character_id, $mail, $datasource, $token, $user_agent, $x_user_agent)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    {
        return $this->postCharactersCharacterIdMailLabelsAsyncWithHttpInfo($character_id, $datasource, $label, $token, $user_agent, $x_user_agent)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    public function putCharactersCharacterIdMailMailIdWithHttpInfo($character_id, $contents, $mail_id, $datasource = 'tranquility', $token = null, $user_agent = null, $x_user_agent = null)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\PutCharactersCharacterIdMailMailIdBadRequest', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 403:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\Forbidden', $e->getResponseHeaders());
    ...
    {
        return $this->putCharactersCharacterIdMailMailIdAsyncWithHttpInfo($character_id, $contents, $mail_id, $datasource, $token, $user_agent, $x_user_agent)->then(function ($response) {
            return $response[0];
        });
    }
