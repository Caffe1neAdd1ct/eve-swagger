...
class MarketApi
{
    ...
    public function getCharactersCharacterIdOrdersWithHttpInfo($character_id, $datasource = 'tranquility', $token = null, $user_agent = null, $x_user_agent = null)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\GetCharactersCharacterIdOrders200Ok[]', $e->getResponseHeaders());
    ...
    {
        return $this->getCharactersCharacterIdOrdersAsyncWithHttpInfo($character_id, $datasource, $token, $user_agent, $x_user_agent)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    {
        return $this->getMarketsGroupsAsyncWithHttpInfo($datasource, $user_agent, $x_user_agent)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    public function getMarketsGroupsMarketGroupIdWithHttpInfo($market_group_id, $datasource = 'tranquility', $language = 'en-us', $user_agent = null, $x_user_agent = null)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\GetMarketsGroupsMarketGroupIdOk', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 404:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\GetMarketsGroupsMarketGroupIdNotFound', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 500:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\InternalServerError', $e->getResponseHeaders());
    ...
    {
        return $this->getMarketsGroupsMarketGroupIdAsyncWithHttpInfo($market_group_id, $datasource, $language, $user_agent, $x_user_agent)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    protected function getMarketsGroupsMarketGroupIdRequest($market_group_id, $datasource = 'tranquility', $language = 'en-us', $user_agent = null, $x_user_agent = null)
    {
        ...
        // path params
        if ($market_group_id !== null) {
            $resourcePath = str_replace('{' . 'market_group_id' . '}', ObjectSerializer::toPathValue($market_group_id), $resourcePath);
        }
    ...
    public function getMarketsPricesWithHttpInfo($datasource = 'tranquility', $user_agent = null, $x_user_agent = null)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\GetMarketsPrices200Ok[]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 500:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\InternalServerError', $e->getResponseHeaders());
    ...
    {
        return $this->getMarketsPricesAsyncWithHttpInfo($datasource, $user_agent, $x_user_agent)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    public function getMarketsRegionIdHistoryWithHttpInfo($region_id, $type_id, $datasource = 'tranquility', $user_agent = null, $x_user_agent = null)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\GetMarketsRegionIdHistory200Ok[]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 422:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\GetMarketsRegionIdHistoryUnprocessableEntity', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 500:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\InternalServerError', $e->getResponseHeaders());
    ...
    {
        return $this->getMarketsRegionIdHistoryAsyncWithHttpInfo($region_id, $type_id, $datasource, $user_agent, $x_user_agent)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    public function getMarketsRegionIdOrdersWithHttpInfo($order_type, $region_id, $datasource = 'tranquility', $page = '1', $type_id = null, $user_agent = null, $x_user_agent = null)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\GetMarketsRegionIdOrders200Ok[]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 422:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\GetMarketsRegionIdOrdersUnprocessableEntity', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 500:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\InternalServerError', $e->getResponseHeaders());
    ...
    {
        return $this->getMarketsRegionIdOrdersAsyncWithHttpInfo($order_type, $region_id, $datasource, $page, $type_id, $user_agent, $x_user_agent)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    public function getMarketsStructuresStructureIdWithHttpInfo($structure_id, $datasource = 'tranquility', $page = '1', $token = null, $user_agent = null, $x_user_agent = null)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\GetMarketsStructuresStructureId200Ok[]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 403:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\Forbidden', $e->getResponseHeaders());
    ...
    {
        return $this->getMarketsStructuresStructureIdAsyncWithHttpInfo($structure_id, $datasource, $page, $token, $user_agent, $x_user_agent)->then(function ($response) {
            return $response[0];
        });
    }
