...
class WarsApi
{
    ...
    {
        return $this->getWarsAsyncWithHttpInfo($datasource, $max_war_id, $user_agent, $x_user_agent)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    public function getWarsWarIdWithHttpInfo($war_id, $datasource = 'tranquility', $user_agent = null, $x_user_agent = null)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\GetWarsWarIdOk', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 422:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\GetWarsWarIdUnprocessableEntity', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 500:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\InternalServerError', $e->getResponseHeaders());
    ...
    {
        return $this->getWarsWarIdAsyncWithHttpInfo($war_id, $datasource, $user_agent, $x_user_agent)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    protected function getWarsWarIdRequest($war_id, $datasource = 'tranquility', $user_agent = null, $x_user_agent = null)
    {
        ...
        // path params
        if ($war_id !== null) {
            $resourcePath = str_replace('{' . 'war_id' . '}', ObjectSerializer::toPathValue($war_id), $resourcePath);
        }
    ...
    public function getWarsWarIdKillmailsWithHttpInfo($war_id, $datasource = 'tranquility', $page = '1', $user_agent = null, $x_user_agent = null)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\GetWarsWarIdKillmails200Ok[]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 422:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\GetWarsWarIdKillmailsUnprocessableEntity', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 500:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\InternalServerError', $e->getResponseHeaders());
    ...
    {
        return $this->getWarsWarIdKillmailsAsyncWithHttpInfo($war_id, $datasource, $page, $user_agent, $x_user_agent)->then(function ($response) {
            return $response[0];
        });
    }
