...
class SovereigntyApi
{
    ...
    public function getSovereigntyCampaignsWithHttpInfo($datasource = 'tranquility', $user_agent = null, $x_user_agent = null)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\GetSovereigntyCampaigns200Ok[]', $e->getResponseHeaders());
    ...
    {
        return $this->getSovereigntyCampaignsAsyncWithHttpInfo($datasource, $user_agent, $x_user_agent)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    public function getSovereigntyMapWithHttpInfo($datasource = 'tranquility', $user_agent = null, $x_user_agent = null)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\GetSovereigntyMap200Ok[]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 500:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\InternalServerError', $e->getResponseHeaders());
    ...
    {
        return $this->getSovereigntyMapAsyncWithHttpInfo($datasource, $user_agent, $x_user_agent)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    public function getSovereigntyStructuresWithHttpInfo($datasource = 'tranquility', $user_agent = null, $x_user_agent = null)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\GetSovereigntyStructures200Ok[]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 500:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\InternalServerError', $e->getResponseHeaders());
    ...
    {
        return $this->getSovereigntyStructuresAsyncWithHttpInfo($datasource, $user_agent, $x_user_agent)->then(function ($response) {
            return $response[0];
        });
    }
