...
class WalletApi
{
     ...
     */
    public function getCharactersCharacterIdWallets($character_id, $datasource = 'tranquility', $token = null, $user_agent = null, $x_user_agent = null)
    {
     ...
     */
    public function getCharactersCharacterIdWalletsWithHttpInfo($character_id, $datasource = 'tranquility', $token = null, $user_agent = null, $x_user_agent = null)
    {
        $returnType = '\Swagger\Client\Model\GetCharactersCharacterIdWallets200Ok[]';
        $request = $this->getCharactersCharacterIdWalletsRequest($character_id, $datasource, $token, $user_agent, $x_user_agent);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\GetCharactersCharacterIdWallets200Ok[]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 403:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\Forbidden', $e->getResponseHeaders());
    ...
    /**
     * Operation getCharactersCharacterIdWalletsAsync
     *
     * List wallets and balances
     *
     * @param int $character_id An EVE character ID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCharactersCharacterIdWalletsAsync($character_id, $datasource = 'tranquility', $token = null, $user_agent = null, $x_user_agent = null)
    {
        return $this->getCharactersCharacterIdWalletsAsyncWithHttpInfo($character_id, $datasource, $token, $user_agent, $x_user_agent)->then(function ($response) {
            return $response[0];
        });
    }

    /**
     * Operation getCharactersCharacterIdWalletsAsyncWithHttpInfo
     *
     * List wallets and balances
     *
     * @param int $character_id An EVE character ID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCharactersCharacterIdWalletsAsyncWithHttpInfo($character_id, $datasource = 'tranquility', $token = null, $user_agent = null, $x_user_agent = null)
    {
        $returnType = '\Swagger\Client\Model\GetCharactersCharacterIdWallets200Ok[]';
        $request = $this->getCharactersCharacterIdWalletsRequest($character_id, $datasource, $token, $user_agent, $x_user_agent);
    ...
    /**
     * Create request for operation 'getCharactersCharacterIdWallets'
     *
     * @param int $character_id An EVE character ID (required)
     * @param string $datasource The server name you would like data from (optional, default to tranquility)
     * @param string $token Access token to use if unable to set a header (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getCharactersCharacterIdWalletsRequest($character_id, $datasource = 'tranquility', $token = null, $user_agent = null, $x_user_agent = null)
    {
        // verify the required parameter 'character_id' is set
        if ($character_id === null) {
     ...
     */
    public function getCharactersCharacterIdWalletsJournal($character_id, $datasource = 'tranquility', $from_id = null, $token = null, $user_agent = null, $x_user_agent = null)
    {
        list($response) = $this->getCharactersCharacterIdWalletsJournalWithHttpInfo($character_id, $datasource, $from_id, $token, $user_agent, $x_user_agent);
        return $response;
    }
     ...
     */
    public function getCharactersCharacterIdWalletsJournalWithHttpInfo($character_id, $datasource = 'tranquility', $from_id = null, $token = null, $user_agent = null, $x_user_agent = null)
    {
        $returnType = '\Swagger\Client\Model\GetCharactersCharacterIdWalletsJournal200Ok[]';
        $request = $this->getCharactersCharacterIdWalletsJournalRequest($character_id, $datasource, $from_id, $token, $user_agent, $x_user_agent);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\GetCharactersCharacterIdWalletsJournal200Ok[]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 403:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\Forbidden', $e->getResponseHeaders());
    ...
    /**
     * Operation getCharactersCharacterIdWalletsJournalAsync
     *
     * Get character wallet journal
     *
     * @param int $character_id An EVE character ID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCharactersCharacterIdWalletsJournalAsync($character_id, $datasource = 'tranquility', $from_id = null, $token = null, $user_agent = null, $x_user_agent = null)
    {
        return $this->getCharactersCharacterIdWalletsJournalAsyncWithHttpInfo($character_id, $datasource, $from_id, $token, $user_agent, $x_user_agent)->then(function ($response) {
            return $response[0];
        });
    }

    /**
     * Operation getCharactersCharacterIdWalletsJournalAsyncWithHttpInfo
     *
     * Get character wallet journal
     *
     * @param int $character_id An EVE character ID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCharactersCharacterIdWalletsJournalAsyncWithHttpInfo($character_id, $datasource = 'tranquility', $from_id = null, $token = null, $user_agent = null, $x_user_agent = null)
    {
        $returnType = '\Swagger\Client\Model\GetCharactersCharacterIdWalletsJournal200Ok[]';
        $request = $this->getCharactersCharacterIdWalletsJournalRequest($character_id, $datasource, $from_id, $token, $user_agent, $x_user_agent);
    ...
    /**
     * Create request for operation 'getCharactersCharacterIdWalletsJournal'
     *
     * @param int $character_id An EVE character ID (required)
     * @param string $datasource The server name you would like data from (optional, default to tranquility)
     * @param int $from_id Only show journal entries happened before the transaction referenced by this id (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getCharactersCharacterIdWalletsJournalRequest($character_id, $datasource = 'tranquility', $from_id = null, $token = null, $user_agent = null, $x_user_agent = null)
    {
        // verify the required parameter 'character_id' is set
        if ($character_id === null) {
