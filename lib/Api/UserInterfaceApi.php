...
class UserInterfaceApi
{
    ...
    {
        return $this->postUiAutopilotWaypointAsyncWithHttpInfo($add_to_beginning, $clear_other_waypoints, $destination_id, $datasource, $token, $user_agent, $x_user_agent)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    {
        return $this->postUiOpenwindowContractAsyncWithHttpInfo($contract_id, $datasource, $token, $user_agent, $x_user_agent)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    {
        return $this->postUiOpenwindowInformationAsyncWithHttpInfo($target_id, $datasource, $token, $user_agent, $x_user_agent)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    {
        return $this->postUiOpenwindowMarketdetailsAsyncWithHttpInfo($type_id, $datasource, $token, $user_agent, $x_user_agent)->then(function ($response) {
            return $response[0];
        });
    }
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 403:
                    ...
                    break;
                case 422:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\PostUiOpenwindowNewmailUnprocessableEntity', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 500:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\InternalServerError', $e->getResponseHeaders());
    ...
    {
        return $this->postUiOpenwindowNewmailAsyncWithHttpInfo($new_mail, $datasource, $token, $user_agent, $x_user_agent)->then(function ($response) {
            return $response[0];
        });
    }
