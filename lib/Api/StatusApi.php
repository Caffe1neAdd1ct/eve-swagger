...
class StatusApi
{
    ...
    public function getStatusWithHttpInfo($datasource = 'tranquility', $user_agent = null, $x_user_agent = null)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\GetStatusOk', $e->getResponseHeaders());
    ...
    {
        return $this->getStatusAsyncWithHttpInfo($datasource, $user_agent, $x_user_agent)->then(function ($response) {
            return $response[0];
        });
    }
