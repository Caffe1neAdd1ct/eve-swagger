...
class CalendarApi
{
    ...
    public function getCharactersCharacterIdCalendarWithHttpInfo($character_id, $datasource = 'tranquility', $from_event = null, $token = null, $user_agent = null, $x_user_agent = null)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\GetCharactersCharacterIdCalendar200Ok[]', $e->getResponseHeaders());
    ...
    {
        return $this->getCharactersCharacterIdCalendarAsyncWithHttpInfo($character_id, $datasource, $from_event, $token, $user_agent, $x_user_agent)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    public function getCharactersCharacterIdCalendarEventIdWithHttpInfo($character_id, $event_id, $datasource = 'tranquility', $token = null, $user_agent = null, $x_user_agent = null)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\GetCharactersCharacterIdCalendarEventIdOk', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 403:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\Forbidden', $e->getResponseHeaders());
    ...
    {
        return $this->getCharactersCharacterIdCalendarEventIdAsyncWithHttpInfo($character_id, $event_id, $datasource, $token, $user_agent, $x_user_agent)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    protected function getCharactersCharacterIdCalendarEventIdRequest($character_id, $event_id, $datasource = 'tranquility', $token = null, $user_agent = null, $x_user_agent = null)
    {
        ...
        // path params
        if ($event_id !== null) {
            $resourcePath = str_replace('{' . 'event_id' . '}', ObjectSerializer::toPathValue($event_id), $resourcePath);
        }
    ...
    {
        return $this->putCharactersCharacterIdCalendarEventIdAsyncWithHttpInfo($character_id, $event_id, $response, $datasource, $token, $user_agent, $x_user_agent)->then(function ($response) {
            return $response[0];
        });
    }
